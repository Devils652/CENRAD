...
<head>
    ...
    <style>
        ...
        .animate-zoom-in {
            ...
            /* Animación más lenta para el fondo */
        }
        ...
        /* Modo de mezcla para el overlay, si se desea un efecto más artístico */
        .blend-overlay {
            background: linear-gradient(to bottom right, rgba(23, 100, 191, 0.7), rgba(0, 150, 199, 0.7));
            /* Azul más oscuro a cian */
            mix-blend-mode: multiply;
            /* Opciones: multiply, overlay, screen, hard-light, etc. */
            opacity: 0.9;
            /* Ajusta la opacidad para ver el fondo a través */
        }
...
<body class="font-sans antialiased bg-gray-50 text-gray-800">
    ...
    <header x-data="{ open: false }" class="bg-white shadow-lg fixed w-full z-50 animate-fade-in-down" style="animation-delay: 0.1s;">
        <nav class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-8">
                ...
                <a href="#contacto" class="text-lg font-medium text-gray-700 hover:text-blue-600 transition duration-300 relative group">
                    Contacto
                    <span class="absolute left-0 bottom-0 w-full h-0.5 bg-blue-600 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-out"></span>
                </a>
            </div>
    ...
    <main>
        <section class="relative h-screen flex items-center justify-center overflow-hidden">
            <div class="absolute inset-0 bg-cover bg-center hero-background animate-zoom-in"></div>
            ...
            <div class="relative z-10 text-center text-white px-6 md:px-0 max-w-4xl">
                ...
                <p class="text-xl md:text-2xl mb-10 text-gray-200 animate-fade-in-up" style="animation-delay: 0.6s;">
                ...
                <div class="flex flex-col sm:flex-row justify-center items-center gap-6 animate-fade-in-up"
                    ...
                    <a href="#contacto" class="border-2 border-white text-white font-bold py-4 px-10 rounded-full text-lg shadow-xl
        ...
        <?php
        // --- SECCIÓN DE DATOS DE TESTIMONIOS ---
// Aquí puedes agregar, editar o eliminar los testimonios fácilmente.
        $testimonials = [
            [
                'name' => 'Iza Triana',
        ...
        <script>
            document.addEventListener('alpine:init', () => {
                Alpine.data('carousel', () => ({
                    init() {
                        // Duplicar el contenido del carrusel para un bucle infinito
        ...
        <style>
            /* Agrega esto en tu CSS o en un bloque <style> */
        ...
        <section id="problemas" class="bg-white py-20 sm:py-28">
            <div class="container mx-auto px-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div
                        class="bg-slate-50 rounded-2xl shadow-lg p-8 transform transition duration-300 hover:-translate-y-2 hover:shadow-2xl flex flex-col">
                    ...
                    <div
                        class="md:col-span-2 lg:col-span-3 bg-blue-700 text-white rounded-2xl shadow-lg p-8 transform transition duration-300 hover:shadow-2xl flex flex-col md:flex-row items-center">
        ...
        <?php
        // --- PRECIOS DE SERVICIOS (Estimados) ---
// Modifica estos precios según tus tarifas reales.
        $services = [
            [
                'name' => 'Rayos X Digital (1 Proyección)',
                'description' => 'Imágenes de alta resolución para diagnósticos óseos, torácicos y abdominales.',
                'price' => 450,
                'is_featured' => false,
            ],
            [
                'name' => 'Tomografía Multicorte (TAC)',
                'description' => 'Estudio detallado de órganos, huesos y tejidos blandos desde múltiples ángulos.',
                'price' => 2800,
                'is_featured' => true,
            ],
            [
                'name' => 'Rayos X a Domicilio',
                'description' => 'Llevamos nuestro equipo de Rayos X Digital a tu hogar. *El precio puede variar por zona.*',
                'price' => 1200,
                'is_featured' => false,
            ],
            [
                'name' => 'Electrocardiograma en Reposo',
                'description' => 'Registro de la actividad eléctrica del corazón para detectar arritmias y otras afecciones.',
                'price' => 400,
                'is_featured' => false,
            ],
            [
                'name' => 'Holter de 24 Horas',
                'description' => 'Monitoreo cardíaco continuo durante 24 horas para un análisis completo.',
                'price' => 1500,
                'is_featured' => false,
            ],
            [
                'name' => 'Espirometría Basal',
                'description' => 'Prueba de función pulmonar para medir la capacidad y el flujo de aire.',
                'price' => 600,
                'is_featured' => false,
            ],
            [
                'name' => 'Audiometría Tonal',
                'description' => 'Evaluación completa de la capacidad auditiva en diferentes frecuencias.',
                'price' => 500,
                'is_featured' => false,
            ],
        ];
                        ...
                        <?php foreach ($services as $service): ?>
                            <div
                                ...
                                <div class="col-span-1 text-center">
                                    <a href="#contacto"
                                        class="w-full md:w-auto bg-cyan-500 text-white font-bold py-2 px-4 rounded-full hover:bg-cyan-600 transition duration-300">
                                        Agendar
                                    </a>
                                </div>
                            </div>
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-blue-800 rounded-2xl p-8 border border-blue-700 hover:border-cyan-400 transition-colors duration-300">
...
<section id="agendar-cita" class="relative bg-white">
    ...
    <div class="relative container mx-auto px-6 py-20 sm:py-28 text-center text-white">
        ...
        <div x-data="{ open_options: false }" class="max-w-2xl mx-auto">
            ...
            <h2 class="text-4xl md:text-5xl font-extrabold leading-tight">Da el Siguiente Paso Hacia tu Bienestar</h2>
            <p class="mt-4 text-lg text-blue-100 mb-10">
            ...
            <div x-show="open_options" 
                 ...
                 style="display: none;"> <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                    ...
                    <a href="https://wa.me/5218112345678" target="_blank" rel="noopener noreferrer" 
                ...
                <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                    ...
                    <a href="tel:+528187654321" class="block w-full text-center bg-cyan-500 font-semibold py-3 px-5 rounded-lg hover:bg-cyan-600 transition duration-300">
                        Marcar Ahora
                    </a>
                </div>
            </div>
